...
网页端“供应商返佣”的规则、金额档位和申报说明向所有账户开放，不包含推广伙伴或现金佣金。普通企业账号从“供应商工作台”的“供应商认证入口”填写企业名称、统一社会信用代码、法定代表人、授权经办人和联系电话，并上传 PDF/JPG/PNG 格式的三证合一营业执照；文件存入非公开材料目录，运营管理员查验营业执照、企业主体和经办人后才能认证通过。认证通过后，返佣材料提交自动解锁。已认证供应商选择自己已验收的真实 GPU 卡时订单并提交交易说明，可附成交或结算凭证；订单金额与成交卡时由平台读取，不能手工篡改。平台以成交卡时为基数，按单笔订单金额匹配比例：1–1,000 元返 1%，1,000–10,000 元返 0.8%，10,000–30,000 元返 0.5%，30,000–50,000 元返 0.3%，超过 50,000 元统一返 0.2%。

供应商选择“5 万元及以下”或“5 万元以上”入口，系统会用订单实际金额校验区间。5 万元及以下提交后自动生成返佣卡时资产并进入供应商算力库；超过 5 万元提交平台审核后发放。重复订单不能重复返佣，争议或退款会阻止申报或冻结、冲正返佣资产，已使用的卡时进入追偿状态。
