...
try {
  ...
  if (migrations.length !== 35 || migrations.at(-1) !== '0035_offer_wizard_draft_abandonment.sql') {
    throw new Error(`Expected migrations 0001..0035; found ${migrations.length}, latest ${migrations.at(-1) ?? 'none'}.`);
  }
