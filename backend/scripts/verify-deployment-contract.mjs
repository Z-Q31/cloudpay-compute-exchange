...
const requiredServiceVariables = [...new Set(readiness.releaseBlockers.map(variableName).filter(Boolean))]
  .filter((name) => name !== 'KAI_CREDIT_TOPUP_PROVIDER_NOT_CONFIGURED');
