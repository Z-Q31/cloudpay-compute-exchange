...
import {
  decryptPii, encryptPii, generateOpaqueToken, generateOtp, lookupHash, maskedPhone, normalizeMainlandPhone,
  otpHash, secretHash,
} from './crypto.js';
...
export class AccountService {
  ...
  async profile(principal: AccountPrincipal) {
    ...
    return {
      ...
      phone: maskedPhone(decryptPii(identity.user.phoneCiphertext, this.piiKey)),
