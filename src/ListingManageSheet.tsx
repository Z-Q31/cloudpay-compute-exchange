    ...
    <Modal visible animationType="slide" transparent onRequestClose={closeSafely}>
      <View style={styles.backdrop}>
        ...
        <View style={styles.sheet}>
          ...
          <Text style={styles.price}>{creditUnitPrice(listing.unitCredits)} KAI 卡时 / {listing.capacityUnit}</Text>
...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.green, fontSize: 10, fontWeight: '900', letterSpacing: 1.3 },
  ...
  primary: { minHeight: 52, marginTop: 18, borderRadius: 17, flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.green },
