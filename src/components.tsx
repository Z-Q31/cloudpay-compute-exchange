...
const providerTabs: Array<{ key: TabKey; label: string; icon: IconName; activeIcon: IconName }> = [
  ...
  { key: 'resources', label: '资源', icon: 'cube-outline', activeIcon: 'cube' },
          ...
          >
            <View style={center ? styles.centerAction : styles.navIconWrap}>
              <Ionicons
                ...
                size={center ? 31 : 23}
                color={center ? colors.surface : selected ? colors.green : colors.muted}
              />
...
const styles = StyleSheet.create({
  ...
  sectionAction: { color: colors.green, fontSize: 14, fontWeight: '700', marginLeft: 10, paddingBottom: 2 },
