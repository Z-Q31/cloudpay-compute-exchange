      ...
      >
        ...
        {snapshot.authenticated && snapshot.unreadCount > 0 ? (
          <Pressable style={styles.readAllButton} onPress={onMarkAllRead}>
            <Ionicons name="checkmark-done-outline" size={17} color={colors.green} />
        ...
        {!snapshot.authenticated ? (
          <Card style={styles.emptyCard}>
            <View style={styles.emptyIcon}>
              <Ionicons name="lock-closed-outline" size={34} color={colors.green} />
            </View>
...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.green, fontSize: 11, fontWeight: '900', letterSpacing: 1.8, marginBottom: 8 },
  title: { color: colors.ink, fontSize: 28, lineHeight: 36, fontWeight: '900', letterSpacing: -0.8 },
  unreadCount: { minWidth: 62, height: 62, paddingHorizontal: 9, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.green },
  ...
  readAllButton: { alignSelf: 'flex-end', minHeight: 40, marginBottom: 10, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 5, borderRadius: 13, backgroundColor: colors.greenSoft },
  readAllText: { color: colors.green, fontSize: 12, fontWeight: '800' },
  ...
  messageActionText: { color: colors.green, fontSize: 11, fontWeight: '900' },
  emptyCard: { padding: 26, alignItems: 'center' },
  emptyIcon: { width: 72, height: 72, borderRadius: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.greenSoft, marginBottom: 16 },
  ...
  loginButton: { minHeight: 44, marginTop: 18, paddingHorizontal: 20, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.green },
